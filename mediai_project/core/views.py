...
def MakePredict(request):
	...
	print(test.shape)
	clf = joblib.load(r'D:\Internship Task\MediAI-Your-Own-Doctor\Model\naive_bayes_model.joblib')
...
def MakeMend(request):
  ...
  if sick in disease_list:
      ...
      clf = joblib.load(r'D:\Internship Task\MediAI-Your-Own-Doctor\Recommendation_Model\recommendation_system_model_1.pkl')
      prediction = clf.predict(test)
